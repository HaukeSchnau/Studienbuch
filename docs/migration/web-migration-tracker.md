...
| `bun --filter @stu/app-mobile lint` | FAIL (known unrelated blocker) | Pre-existing mobile lint issues; not a web cutover gate |
| `bun --filter @stu/app-mobile typecheck` | FAIL (known unrelated blocker) | Pre-existing mobile type issues; not a web cutover gate |
