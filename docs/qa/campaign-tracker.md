...
| QA-002 | Mobile lifecycle Maestro flows fail at `assertVisible: "ready"` on iOS and Android | S1 | Reproduced | Orchestrator | `.artifacts/qa/20260304T231118Z/*maestro-lifecycle.log` | 2026-03-04 | Reproduce with E2E route/runtime instrumentation and add failing regression guard |
...
- [ ] QA-002: Mobile lifecycle Maestro flows fail at `ready`
