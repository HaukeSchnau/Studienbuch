...
- `project.nix` now owns the shared typed declaration. Runtime JSON is generated by preparation/builds; the source JSON was removed in the September 16 split.
