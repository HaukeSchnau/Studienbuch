...
import type { MenuElement } from "./utils";
 ...
 * @hidden
 */
export interface ContextMenuElementBase {
 ...
 */
export function Submenu(_props: SubmenuProps) {
  return <></>;
}
 ...
 */
export function Items(_props: { children: React.ReactNode }) {
  return <></>;
}
Items.tag = "Items";
/**
...
function ContextMenu(props: ContextMenuProps) {
  ...
  const createEventHandler =
    ...
    (event: NativeSyntheticEvent<{ contextMenuElementID: string }>) => {
      const handler =
        eventHandlersMap[event.nativeEvent.contextMenuElementID]?.[handlerType];
      handler?.(event);
    };
