 ...
 * Only for checkbox.
 */
interface CheckboxElementColors {
  checkedColor?: string;
...
export interface SwitchSwitchVariantProps {
  variant?: "switch";
  /**
...
export interface SwitchCheckboxVariantProps {
  variant: "checkbox";
  /**
...
export interface SwitchButtonVariantProps {
  variant: "button";
...
const SwitchNativeView: React.ComponentType<NativeSwitchProps> =
  requireNativeView("ExpoUI", "SwitchView");
