...
class SyncInput {
  ...
  factory SyncInput.fromJson(dynamic json) {
    return SyncInput(
        courseIds:
            (json['courseIds'] as List<dynamic>).map<int>((e) => e).toList(),
        classIds:
            (json['classIds'] as List<dynamic>).map<int>((e) => e).toList(),
...
enum SyncOutputUpdatedCourseTimesWeeksEnum {
  ...
  factory SyncOutputUpdatedCourseTimesWeeksEnum.fromJson(String json) {
    switch (json) {
      case 'EVEN':
        return SyncOutputUpdatedCourseTimesWeeksEnum.even;
      case 'ODD':
        return SyncOutputUpdatedCourseTimesWeeksEnum.odd;
      case 'BOTH':
        return SyncOutputUpdatedCourseTimesWeeksEnum.both;
      default:
...
class SyncOutput {
  ...
  factory SyncOutput.fromJson(dynamic json) {
    return SyncOutput(
        updatedCourses: (json['updatedCourses'] as List<dynamic>)
            .map<SyncOutputUpdatedCourses>(
                (e) => SyncOutputUpdatedCourses.fromJson(e))
            .toList(),
        updatedCourseTimes: (json['updatedCourseTimes'] as List<dynamic>)
            .map<SyncOutputUpdatedCourseTimes>(
                (e) => SyncOutputUpdatedCourseTimes.fromJson(e))
            .toList(),
        updatedClasses: (json['updatedClasses'] as List<dynamic>)
            .map<SyncOutputUpdatedClasses>(
                (e) => SyncOutputUpdatedClasses.fromJson(e))
            .toList(),
        updatedYears: (json['updatedYears'] as List<dynamic>)
            .map<SyncOutputUpdatedYears>(
                (e) => SyncOutputUpdatedYears.fromJson(e))
            .toList(),
        updatedUsers: (json['updatedUsers'] as List<dynamic>)
            .map<SyncOutputUpdatedUsers>(
                (e) => SyncOutputUpdatedUsers.fromJson(e))
            .toList());
  }
...
class LicenseCheckInput {
  ...
  LicenseCheckInput({required this.licenseKey});

  factory LicenseCheckInput.fromJson(dynamic json) {
    return LicenseCheckInput(licenseKey: json['licenseKey']);
  }
...
enum LicenseCheckOutputEnum {
  ...
  factory LicenseCheckOutputEnum.fromJson(String json) {
    switch (json) {
      case 'INVALID':
        return LicenseCheckOutputEnum.invalid;
      case 'EXPIRED':
        return LicenseCheckOutputEnum.expired;
      case 'ACTIVATED':
        return LicenseCheckOutputEnum.activated;
      case 'VALID':
        return LicenseCheckOutputEnum.valid;
      default:
        throw Exception('Unknown enum value: $json');
    }
  }
...
class YearsListInput {
  final num? school;

  YearsListInput({required this.school});

  factory YearsListInput.fromJson(dynamic json) {
    return YearsListInput(school: json['school']);
  }
  ...
  factory YearsListGroupedBySchoolOutput.fromJson(dynamic json) {
    return YearsListGroupedBySchoolOutput(
        years: (json['years'] as List<dynamic>)
            .map<YearsListGroupedBySchoolOutputYears>(
                (e) => YearsListGroupedBySchoolOutputYears.fromJson(e))
            .toList(),
        id: json['id'],
        name: json['name'],
        createdAt: DateTime.parse(json['createdAt']),
...
class ClassesListInput {
  ...
  ClassesListInput({required this.yearId});

  factory ClassesListInput.fromJson(dynamic json) {
    return ClassesListInput(yearId: json['yearId']);
  }
  ...
  factory ClassesListOutput.fromJson(dynamic json) {
    return ClassesListOutput(
        ...
        courses: (json['courses'] as List<dynamic>)
            .map<ClassesListOutputCourses>(
                (e) => ClassesListOutputCourses.fromJson(e))
            .toList(),
        yearId: json['yearId'],
        identifierInYear: json['identifierInYear']);
  }
...
class CoursesListOutputTeacher {
  ...
  CoursesListOutputTeacher(
      {required this.name, required this.id, required this.title});

  factory CoursesListOutputTeacher.fromJson(dynamic json) {
    return CoursesListOutputTeacher(
        name: json['name'], id: json['id'], title: json['title']);
  }

  dynamic toJson() {
    return {'name': name, 'id': id, 'title': title};
  }
}
...
class CoursesAddCoursesInputCourses {
  ...
  factory CoursesAddCoursesInputCourses.fromJson(dynamic json) {
    return CoursesAddCoursesInputCourses(
        ...
        times: (json['times'] as List<dynamic>)
            .map<CoursesAddCoursesInputCoursesTimes>(
                (e) => CoursesAddCoursesInputCoursesTimes.fromJson(e))
            .toList(),
...
class SubstitutionsGetInput {
  ...
  SubstitutionsGetInput({required this.date});
...
enum SubstitutionsGetOutputTypeEnum {
  ...
  factory SubstitutionsGetOutputTypeEnum.fromJson(String json) {
    switch (json) {
      case 'FREISETZUNG':
        return SubstitutionsGetOutputTypeEnum.freisetzung;
      case 'VERTRETUNG':
        return SubstitutionsGetOutputTypeEnum.vertretung;
      case 'BETREUUNG':
        return SubstitutionsGetOutputTypeEnum.betreuung;
      case 'ENTFALL':
        return SubstitutionsGetOutputTypeEnum.entfall;
      case 'TROTZ_ABSENZ':
        return SubstitutionsGetOutputTypeEnum.trotzAbsenz;
      default:
        throw Exception('Unknown enum value: $json');
    }
  }
...
class SubstitutionsGetOutput {
  ...
  factory SubstitutionsGetOutput.fromJson(dynamic json) {
    return SubstitutionsGetOutput(
        type: json['type'] != null
            ? SubstitutionsGetOutputTypeEnum.fromJson(json['type'])
            : null,
...
class SubscriptionsSubscribeInput {
  ...
  SubscriptionsSubscribeInput(
      {required this.courses, required this.messagingToken});
...
class AuthGetSessionOutputUser {
  ...
  AuthGetSessionOutputUser(
      {required this.id, required this.name, required this.isSuperUser});

  factory AuthGetSessionOutputUser.fromJson(dynamic json) {
    return AuthGetSessionOutputUser(
        id: json['id'], name: json['name'], isSuperUser: json['isSuperUser']);
  }

  dynamic toJson() {
    return {'id': id, 'name': name, 'isSuperUser': isSuperUser};
  }
}
...
class AuthGetSessionOutput {
  ...
  AuthGetSessionOutput({required this.user, required this.token});

  factory AuthGetSessionOutput.fromJson(dynamic json) {
    return AuthGetSessionOutput(
        user: json['user'] != null
            ? AuthGetSessionOutputUser.fromJson(json['user'])
            : null,
        token: json['token']);
  }
...
class AuthGetPermissionsOutput {
  final bool isSuperUser;

  AuthGetPermissionsOutput({required this.isSuperUser});

  factory AuthGetPermissionsOutput.fromJson(dynamic json) {
    return AuthGetPermissionsOutput(isSuperUser: json['isSuperUser']);
  }
...
class SchoolsSetThemeInputThemePrimaryDefault {
  final String color;
  final String on;

  SchoolsSetThemeInputThemePrimaryDefault(
      {required this.color, required this.on});

  factory SchoolsSetThemeInputThemePrimaryDefault.fromJson(dynamic json) {
    return SchoolsSetThemeInputThemePrimaryDefault(
        color: json['color'], on: json['on']);
  }

  dynamic toJson() {
    return {'color': color, 'on': on};
  }
}

class SchoolsSetThemeInputThemePrimary {
  final SchoolsSetThemeInputThemePrimaryDefault def;
  final String text;
  final SchoolsSetThemeInputThemePrimaryDefault des;
  final SchoolsSetThemeInputThemePrimaryDefault pale;

  SchoolsSetThemeInputThemePrimary(
      {required this.def,
      required this.text,
      required this.des,
      required this.pale});

  factory SchoolsSetThemeInputThemePrimary.fromJson(dynamic json) {
    return SchoolsSetThemeInputThemePrimary(
        def: SchoolsSetThemeInputThemePrimaryDefault.fromJson(json['default']),
        text: json['text'],
        des: SchoolsSetThemeInputThemePrimaryDefault.fromJson(json['des']),
        pale: SchoolsSetThemeInputThemePrimaryDefault.fromJson(json['pale']));
  }
...
class SchoolsSetThemeInputThemeAccent {
  final SchoolsSetThemeInputThemePrimaryDefault def;
  final SchoolsSetThemeInputThemePrimaryDefault des;
  final SchoolsSetThemeInputThemePrimaryDefault pale;
  final SchoolsSetThemeInputThemePrimaryDefault sec;

  SchoolsSetThemeInputThemeAccent(
      {required this.def,
      required this.des,
      required this.pale,
      required this.sec});

  factory SchoolsSetThemeInputThemeAccent.fromJson(dynamic json) {
    return SchoolsSetThemeInputThemeAccent(
        def: SchoolsSetThemeInputThemePrimaryDefault.fromJson(json['default']),
        des: SchoolsSetThemeInputThemePrimaryDefault.fromJson(json['des']),
        pale: SchoolsSetThemeInputThemePrimaryDefault.fromJson(json['pale']),
        sec: SchoolsSetThemeInputThemePrimaryDefault.fromJson(json['sec']));
  }
...
class SchoolsSetThemeInputThemeDanger {
  final SchoolsSetThemeInputThemePrimaryDefault def;
  final SchoolsSetThemeInputThemePrimaryDefault des;
  final SchoolsSetThemeInputThemePrimaryDefault sec;

  SchoolsSetThemeInputThemeDanger(
      {required this.def, required this.des, required this.sec});

  factory SchoolsSetThemeInputThemeDanger.fromJson(dynamic json) {
    return SchoolsSetThemeInputThemeDanger(
        def: SchoolsSetThemeInputThemePrimaryDefault.fromJson(json['default']),
        des: SchoolsSetThemeInputThemePrimaryDefault.fromJson(json['des']),
        sec: SchoolsSetThemeInputThemePrimaryDefault.fromJson(json['sec']));
  }
  ...
  dynamic toJson() {
    return {'default': def.toJson(), 'des': des.toJson(), 'sec': sec.toJson()};
  }
}

class SchoolsSetThemeInputThemeAlert {
  final SchoolsSetThemeInputThemePrimaryDefault def;
  final SchoolsSetThemeInputThemePrimaryDefault des;

  SchoolsSetThemeInputThemeAlert({required this.def, required this.des});

  factory SchoolsSetThemeInputThemeAlert.fromJson(dynamic json) {
    return SchoolsSetThemeInputThemeAlert(
        def: SchoolsSetThemeInputThemePrimaryDefault.fromJson(json['default']),
        des: SchoolsSetThemeInputThemePrimaryDefault.fromJson(json['des']));
  }

  dynamic toJson() {
    return {'default': def.toJson(), 'des': des.toJson()};
  }
}

class SchoolsSetThemeInputThemeSuccess {
  final SchoolsSetThemeInputThemePrimaryDefault def;
  final SchoolsSetThemeInputThemePrimaryDefault des;
  final SchoolsSetThemeInputThemePrimaryDefault pale;

  SchoolsSetThemeInputThemeSuccess(
      {required this.def, required this.des, required this.pale});

  factory SchoolsSetThemeInputThemeSuccess.fromJson(dynamic json) {
    return SchoolsSetThemeInputThemeSuccess(
        def: SchoolsSetThemeInputThemePrimaryDefault.fromJson(json['default']),
        des: SchoolsSetThemeInputThemePrimaryDefault.fromJson(json['des']),
        pale: SchoolsSetThemeInputThemePrimaryDefault.fromJson(json['pale']));
  }
...
class SchoolsSetThemeInputThemeNeutral {
  final SchoolsSetThemeInputThemePrimaryDefault def;
  final SchoolsSetThemeInputThemePrimaryDefault sec;

  SchoolsSetThemeInputThemeNeutral({required this.def, required this.sec});

  factory SchoolsSetThemeInputThemeNeutral.fromJson(dynamic json) {
    return SchoolsSetThemeInputThemeNeutral(
        def: SchoolsSetThemeInputThemePrimaryDefault.fromJson(json['default']),
        sec: SchoolsSetThemeInputThemePrimaryDefault.fromJson(json['sec']));
  }

  dynamic toJson() {
    return {'default': def.toJson(), 'sec': sec.toJson()};
  }
}

class SchoolsSetThemeInputThemeSurface {
  final SchoolsSetThemeInputThemePrimaryDefault def;

  SchoolsSetThemeInputThemeSurface({required this.def});

  factory SchoolsSetThemeInputThemeSurface.fromJson(dynamic json) {
    return SchoolsSetThemeInputThemeSurface(
        def: SchoolsSetThemeInputThemePrimaryDefault.fromJson(json['default']));
  }

  dynamic toJson() {
    return {'default': def.toJson()};
  }
}

class SchoolsSetThemeInputTheme {
  final SchoolsSetThemeInputThemePrimary primary;
  final SchoolsSetThemeInputThemeAccent accent;
  final SchoolsSetThemeInputThemeDanger danger;
  final SchoolsSetThemeInputThemeAlert alert;
  final SchoolsSetThemeInputThemeSuccess success;
  final SchoolsSetThemeInputThemeNeutral neutral;
  final SchoolsSetThemeInputThemeSurface surface;
  final SchoolsSetThemeInputThemeSurface background;

  SchoolsSetThemeInputTheme(
  ...
  factory SchoolsSetThemeInputTheme.fromJson(dynamic json) {
    return SchoolsSetThemeInputTheme(
        primary: SchoolsSetThemeInputThemePrimary.fromJson(json['primary']),
        accent: SchoolsSetThemeInputThemeAccent.fromJson(json['accent']),
        danger: SchoolsSetThemeInputThemeDanger.fromJson(json['danger']),
        alert: SchoolsSetThemeInputThemeAlert.fromJson(json['alert']),
        success: SchoolsSetThemeInputThemeSuccess.fromJson(json['success']),
        neutral: SchoolsSetThemeInputThemeNeutral.fromJson(json['neutral']),
        surface: SchoolsSetThemeInputThemeSurface.fromJson(json['surface']),
        background:
            SchoolsSetThemeInputThemeSurface.fromJson(json['background']));
  }
...
class SchoolsSetThemeInput {
  final num school;
  final String image;
  final SchoolsSetThemeInputTheme theme;

  SchoolsSetThemeInput(
      {required this.school, required this.image, required this.theme});

  factory SchoolsSetThemeInput.fromJson(dynamic json) {
    return SchoolsSetThemeInput(
        school: json['school'],
        image: json['image'],
        theme: SchoolsSetThemeInputTheme.fromJson(json['theme']));
  }

  dynamic toJson() {
    return {'school': school, 'image': image, 'theme': theme.toJson()};
  }
}

class SchoolsGetThemeOutput {
  final SchoolsSetThemeInputTheme theme;
  final String image;

  SchoolsGetThemeOutput({required this.theme, required this.image});

  factory SchoolsGetThemeOutput.fromJson(dynamic json) {
    return SchoolsGetThemeOutput(
        theme: SchoolsSetThemeInputTheme.fromJson(json['theme']),
        image: json['image']);
  }

  dynamic toJson() {
    return {'theme': theme.toJson(), 'image': image};
  }
}
...
class UsersListOutputRoles {
  ...
  UsersListOutputRoles(
      {required this.id, required this.name, required this.defaultScope});

  factory UsersListOutputRoles.fromJson(dynamic json) {
    return UsersListOutputRoles(
        id: json['id'], name: json['name'], defaultScope: json['defaultScope']);
  }

  dynamic toJson() {
    return {'id': id, 'name': name, 'defaultScope': defaultScope};
  }
}
...
enum UsersListOutputPermissionsPermissionEnum {
  ...
  factory UsersListOutputPermissionsPermissionEnum.fromJson(String json) {
    switch (json) {
      case 'EDIT_INFO_PAGES':
        return UsersListOutputPermissionsPermissionEnum.editInfoPages;
      case 'EDIT_USERS':
        return UsersListOutputPermissionsPermissionEnum.editUsers;
      case 'EDIT_COURSES':
        return UsersListOutputPermissionsPermissionEnum.editCourses;
      case 'EDIT_YEARS':
        return UsersListOutputPermissionsPermissionEnum.editYears;
      case 'EDIT_CLASSES':
        return UsersListOutputPermissionsPermissionEnum.editClasses;
      case 'EDIT_SCHOOLS':
        return UsersListOutputPermissionsPermissionEnum.editSchools;
      case 'VIEW_LOGS':
        return UsersListOutputPermissionsPermissionEnum.viewLogs;
      default:
        throw Exception('Unknown enum value: $json');
    }
  }
...
class UsersListOutputPermissions {
  ...
  UsersListOutputPermissions(
      {required this.permission, required this.userId, required this.scope});

  factory UsersListOutputPermissions.fromJson(dynamic json) {
    return UsersListOutputPermissions(
        permission: UsersListOutputPermissionsPermissionEnum.fromJson(
            json['permission']),
        userId: json['userId'],
        scope: json['scope']);
  }
  ...
  factory UsersListOutput.fromJson(dynamic json) {
    return UsersListOutput(
        ...
        roles: (json['roles'] as List<dynamic>)
            .map<UsersListOutputRoles>((e) => UsersListOutputRoles.fromJson(e))
            .toList(),
        permissions: (json['permissions'] as List<dynamic>)
            .map<UsersListOutputPermissions>(
                (e) => UsersListOutputPermissions.fromJson(e))
            .toList(),
        id: json['id'],
        email: json['email'],
        name: json['name'],
...
class UsersUpdatePasswordInput {
  ...
  UsersUpdatePasswordInput({required this.id, required this.password});

  factory UsersUpdatePasswordInput.fromJson(dynamic json) {
    return UsersUpdatePasswordInput(id: json['id'], password: json['password']);
  }
...
enum UsersListScopeOptionsInputEnum {
  ...
  factory UsersListScopeOptionsInputEnum.fromJson(String json) {
    switch (json) {
      ...
      case 'schools':
        return UsersListScopeOptionsInputEnum.schools;
      default:
        throw Exception('Unknown enum value: $json');
    }
  }
...
class UsersListScopeOptionsOutput {
  ...
  UsersListScopeOptionsOutput({required this.name, required this.id});

  factory UsersListScopeOptionsOutput.fromJson(dynamic json) {
    return UsersListScopeOptionsOutput(name: json['name'], id: json['id']);
  }
...
class UsersSetPermissionsInputPermissions {
  ...
  UsersSetPermissionsInputPermissions(
      {required this.permission, required this.scope});
  ...
  dynamic toJson() {
    return {'permission': permission.toString(), 'scope': null};
  }
}
...
class UsersSetPermissionsInput {
  ...
  factory UsersSetPermissionsInput.fromJson(dynamic json) {
    return UsersSetPermissionsInput(
        ...
        isSuperUser: json['isSuperUser'],
        permissions: (json['permissions'] as List<dynamic>)
            .map<UsersSetPermissionsInputPermissions>(
                (e) => UsersSetPermissionsInputPermissions.fromJson(e))
            .toList());
  }
