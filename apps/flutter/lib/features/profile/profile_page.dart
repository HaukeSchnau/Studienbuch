...
import 'package:class_mate/features/profile/subjects_grid.dart';
import 'package:class_mate/models/semester.dart';
import 'package:class_mate/features/profile/smol_card.dart';
import 'package:class_mate/features/profile/top_panel.dart';
import 'package:class_mate/presentation/components/simple_scaffold.dart';
import 'package:class_mate/presentation/components/tab_bar_view.dart';
...
class ProfilePage extends HookWidget {
  ...
  Widget build(BuildContext context) {
    final year = useYear();
    final semesters = getRelevantSemesters(year);
